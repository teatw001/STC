    ...
    <>
      <section className="relative bg-[url(/banner-home.png/)] bg-cover w-full bg-center bg-no-repeat">
        ...
        <div className="text-center my-10 px-10 h-screen py-[200px]  max-w-screen-xl mx-auto">
          ...
          <p className="text-[#FFFFFF] mx-auto px-20 py-10">
            Trải nghiệm rạp chiếu phim hơn bao giờ hết - chúng tôi cung cấp công
            nghệ tiên tiến, chỗ ngồi thoải mái và tuyển chọn phim đa dạng. Đặt
            phòng dễ dàng trên trang web của chúng tôi và tận hưởng những lợi
            ích độc quyền!
          </p>
          <Link
            to={"/ticket"}
      ...
      <div className="Special Features  max-w-6xl  px-10 mx-auto my-[66px]">
        ...
        <div className="Special Features img grid grid-cols-2 gap-8 my-10">
          <Link to={"#"}>
            <img src="/special-1.png/" className="rounded-xl" alt="" />
          </Link>
          <Link to={"#"}>
            <img src="/special-2.png/" className="rounded-xl" alt="" />
          </Link>
          <Link to={"#"}>
            <img src="/special-3.png/" className="rounded-xl" alt="" />
          </Link>
          <Link to={"#"}>
            <img src="/special-4.png/" className="rounded-xl" alt="" />
          </Link>
        </div>
        <span className="block text-center">
      ...
      <div className="Questions max-w-5xl  px-10 mx-auto my-[133px] ">
        ...
        <span className="block text-[#8E8E8E] text-[17px] w-[550px] mx-auto text-center ">
          Nếu bạn cần hỗ trợ hoặc có bất kỳ thắc mắc nào, vui lòng hỏi. Chúng
          tôi sẵn sàng hỗ trợ bạn trong suốt toàn bộ quá trình.
        </span>
